...
** TODO Render river ribbons from reaches

Terrain Lab now shows coherent dry reaches above a contributing-area
threshold, stopping at lake inlets and resuming at spills.  The next step is a
world-space ribbon representation that follows those ordered cells, widens
with discharge, stays slightly above its bed, and carries flow coordinates for
animated detail.  It should remain presentation only until its alignment has
been judged from the motorcycle.

Acceptance evidence:

- Ribbons join cleanly at confluences and water-body boundaries.
- Width and animation direction visibly agree with discharge and routing.
- Near-field rivers survive rider-scale inspection without excessive z-fight.
- Rendering remains downstream of the reading and does not edit terrain.

...
namespace moppe {
  ...
  namespace platform {
    ...
    public:
      ...
      virtual void resize (int w_pts, int h_pts) {
        (void)w_pts;
        (void)h_pts;
      }
      virtual void tick (float dt) = 0;
      virtual void render (render::Renderer& r) = 0;
      virtual void key (Key k, bool down) {
        (void)k;
        (void)down;
      }
      virtual void controls (const ControlState& state) {
        (void)state;
      }
      ...
      virtual void
      pointer_button (PointerButton button, bool down, float x, float y) {
        (void)button;
        (void)down;
        (void)x;
        (void)y;
